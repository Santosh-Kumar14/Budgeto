...
This step establishes the **data layer foundation** for the Budgeto application.
...
- Opens connection to `budgeto.db` (or `expense_tracker.db`) in project root
- Sets:
...
- Inserts one demo user:
    - name: Demo User
    - email: [demo@budgeto.com](mailto:demo@budgeto.com)
