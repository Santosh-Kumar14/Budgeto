...
DB_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), "budgeto.db")
...
def seed_db():
    ...
    cursor = conn.execute(
        ...
        ("Demo User", "demo@budgeto.com", generate_password_hash("demo123")),
    )
    ...
    conn.executemany(
        ...
        [
            ...
            (user_id, 60.00,  "Food",          "2026-05-17", "Restaurant dinner"),
        ],
    )
    conn.commit()
    conn.close()
